...
export const initialContainers: Container[] = [
  ...
  { id: 'c6b', emoji: '🥔', name: 'Grow Bag 2', size: '40–50 L', use: 'Potatoes #2 — second bag for larger yield. Maris Piper or Charlotte.' },
  { id: 'c7', emoji: '🥕', name: 'Grow Bag 3', size: '40–50 L', use: 'Carrots — sow directly in rows. Nantes 2 or Chantenay Red Cored.' },
  { id: 'c7b', emoji: '🌿', name: 'Grow Bag 4', size: 'Large (40–50 L+)', use: 'Fig — transfer from patio pot as season progresses to allow a bigger tree. Move to shed in hard frosts.' },
  ...
  { id: 'c10', emoji: '🍓', name: 'Strawberries', size: 'Individual pots', use: 'Strawberries in individual pots — growhouse in hard frosts.' },
